...
export default function FooterComponent() {
  return (
    <>
       <div class="container-fluid" id="footer-mainsection">
            <div class="container">
                <div class="row p-lg-3 p-md-3" >
                    <div class=" col-lg-3 col-md-3 col-sm-6" >
                        <div class="p-2">
                            <img src={footerimg} id="footer-subsection1image" alt=""/>
                            <p class="mt-2 text-light fs-6" id="footer-subsection1">Mauris malesuada arcu eu posuere ele ifen. Ut egestas tortor at leo egestas tincidunt. Nam tincidunt metus tristique tristique viverra. Mauris erat ante, egestas vitae dapibus sed.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="ms-lg-5 p-lg-2 p-md-2">
                            <p class="text-light fw-bold fs-4 ms-lg-4">Movie Category</p>
                            <ul class="text-light text-start list-unstyled ms-lg-4">
                    ...
                    <div class="row ">
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <ul class="d-lg-flex d-md-flex d-sm-flex  text-light list-unstyled m-lg-2">
                                <li class="ms-lg-3 ms-md-3 ms-sm-3 ">About Us</li>
